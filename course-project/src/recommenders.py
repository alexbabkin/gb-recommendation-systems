...
class MainRecommender:
    ...
    def __init__(self, data: pd.DataFrame, weighting=None):
    ...
    def get_embeddings(self):
        items_emb_df = pd.DataFrame(self.model.item_factors)
        ...
        users_emb_df = pd.DataFrame(self.model.user_factors)
    ...
    def get_top_popular(self):
        return self.overall_top_purchases
    ...
    @staticmethod
    def fit(user_item_matrix, n_factors=20, regularization=0.001, iterations=15, num_threads=3):
        """Обучает ALS"""
